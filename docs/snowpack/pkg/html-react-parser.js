import { c as createCommonjsModule, a as commonjsGlobal, r as react, g as getDefaultExportFromNamespaceIfNotNamed } from './common/index-6e61f04f.js';
...
var attributesToProps = function attributesToProps(attributes) {
  ...
  for (attributeName in attributes) {
    ...
    if (lib.isCustomAttribute(attributeName)) {
    ...
    if (propName) {
      propertyInfo = lib.getPropertyInfo(propName);
...
function getPropName(attributeName) {
  return lib.possibleStandardNames[attributeName];
}

var setStyleProp$1 = utilities$1.setStyleProp;
var canTextBeChildOfNode$1 = utilities$1.canTextBeChildOfNode;
...
function domToReact(nodes, options) {
  ...
  for (var i = 0, len = nodes.length; i < len; i++) {
    ...
    if (node.type === 'text') {
      ...
      if (isWhitespace && node.parent && !canTextBeChildOfNode$1(node.parent)) {
    ...
    if (skipAttributesToProps(node)) {
      setStyleProp$1(props.style, props);
    } else if (props) {
...
var nodeTypes = new Map([
    [lib$1.ElementType.Tag, 1],
    [lib$1.ElementType.Script, 1],
    [lib$1.ElementType.Style, 1],
    [lib$1.ElementType.Directive, 1],
    [lib$1.ElementType.Text, 3],
    [lib$1.ElementType.CDATA, 4],
    [lib$1.ElementType.Comment, 8],
    [lib$1.ElementType.Root, 9],
]);
/**
...
var Text = /** @class */ (function (_super) {
    ...
    function Text(data) {
        return _super.call(this, lib$1.ElementType.Text, data) || this;
    }
    return Text;
}(DataNode));
exports.Text = Text;
...
var Comment = /** @class */ (function (_super) {
    ...
    function Comment(data) {
        return _super.call(this, lib$1.ElementType.Comment, data) || this;
    }
    return Comment;
}(DataNode));
...
var ProcessingInstruction = /** @class */ (function (_super) {
    ...
    function ProcessingInstruction(name, data) {
        var _this = _super.call(this, lib$1.ElementType.Directive, data) || this;
        _this.name = name;
        return _this;
    }
...
var Document = /** @class */ (function (_super) {
    ...
    function Document(children) {
        return _super.call(this, lib$1.ElementType.Root, children) || this;
    }
    return Document;
}(NodeWithChildren));
...
var Element = /** @class */ (function (_super) {
    ...
    function Element(name, attribs, children, type) {
        ...
        if (type === void 0) { type = name === "script"
            ? lib$1.ElementType.Script
            : name === "style"
                ? lib$1.ElementType.Style
                : lib$1.ElementType.Tag; }
...
function isCDATA(node) {
    return node.type === lib$1.ElementType.CDATA;
}
...
function isText(node) {
    return node.type === lib$1.ElementType.Text;
}
...
function isComment(node) {
    return node.type === lib$1.ElementType.Comment;
}
...
function isDirective(node) {
    return node.type === lib$1.ElementType.Directive;
}
...
function isDocument(node) {
    return node.type === lib$1.ElementType.Root;
}
...
function cloneNode(node, recursive) {
    ...
    if (isText(node)) {
        ...
        var children = recursive ? cloneChildren(node.children) : [];
        var clone_2 = new NodeWithChildren(lib$1.ElementType.CDATA, children);
...
var require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(htmlDomParser);
